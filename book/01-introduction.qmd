...
If you want to learn more about the underlying theory and similar techniques, we highly recommend the presentations by Madlene Nussbaum given at the summer school of the OpenGeoHub Foundation (see part [1](https://www.youtube.com/watch?v=NgZ17CbL_xs) and [2](https://www.youtube.com/watch?v=idkODq0BpAA)).
